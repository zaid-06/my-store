...
// import * as downloadRepository from "../../src/modules/downloads/download.db";
...
//     (downloadRepository.getDownloadByToken as any).mockResolvedValue(null);

//     await expect(
//       getDownloadService("invalid-token", { ip: "127.0.0.1", headers: {} } as any)
...
//     (downloadRepository.getDownloadByToken as any).mockResolvedValue({
//       order: { status: "PENDING" },
//     });

//     await expect(
//       getDownloadService("token", { ip: "127.0.0.1", headers: {} } as any)
